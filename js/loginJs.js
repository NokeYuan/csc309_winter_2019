...
function changeLogin(e){
      ...
      document.getElementById("signUpButton").outerHTML = '<button type="button" id = "signUpButton"><span class="infoText" style="text-align: center; font-size: 90%;">Log in</span></button>'
      ...
      signup.innerHTML = '<button type="button" id = "signUpButton"><span class="infoText" style="text-align: center; font-size: 90%;">Sign up</span></button>'
